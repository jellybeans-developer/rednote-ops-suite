...
- **Browser automation remains experimental.** Selectors can break when Creator Center changes. Platform acceptance does not guarantee later content-review approval, so the operator must check content management status.
